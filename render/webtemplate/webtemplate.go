...
func (this *Template) Render(writer *http.ResponseWriter,filepathList []string,output interface{},errorInfo map[string][]string) error {
  var err error = nil
  switch this.Templatetype {
    case HTML_TEMPLATE:
      htmltemp := &HtmlTemplate{(*this)}
      err = htmltemp.RenderHTMLTemplate(writer,filepathList,output,errorInfo)
    case JSON_TEMPLATE:
    case XML_TEMPLATE:
    case TEXT_TEMPLATE:
    default:
