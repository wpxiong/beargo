...
func (this *sessionManager ) LoadSessionBySessionId (valueId string,bytearray []byte, obj interface{},sess *Session) bool {
   return this.Sessionprovider.DeseriazeObject(valueId,bytearray,obj,sess)
}